                            ...
                            <div class="inProgress-block" id="inProgress-block" data-line="{{$key}}"
                                ...
                                <div class="singer-info">
                                    <div class="singer-img">
                                        ...
                                        <img src="{{url("storage/uploads/cover_photos/$song->cover_name")}}" alt="">
                                    </div>
                                    <div class="song-name">
                                        <div class="page-title--2">
                                            {{$song->record_label}}
                                        </div>
                                        <div class="singer-name page-title--3">{{$song->record_artist}}</div>
                                    </div>
                                ...
                                <div class="song-info">
                                    ...
                                    <div class="song-info--item">
                                        ...
                                        <span>{{$song->music_publisher}}</span>
                                    </div>
                                    {{--                                    <div class="song-info--item">--}}
                                ...
                                <div class="song_edit">
                                    <a class="see_data" href="{{route('album.atwork', ['song_id' => $song->id, 'which' => 'song'])}}"
                                    >See MetaData
                                    </a>
                                    ...
                                    <tr class="green-bg" data-id="{{$song->id}}">
                                        ...
                                        <td class="block-1--description">
                                            <img class="photo-track-tab"
                                                 src="{{url('/') . '/storage/uploads/cover_photos/' . $song->cover_name}}"
                                                 alt="">
                                        </td>
                                        <td class="block-1--description">{{$song->music_original_name}}</td>
    ...
    <div id="remove" class="modal">
        <div class="modal-content remove-content">
            ...
            <div class="remove-info">
                ...
                <form class="remove-form" id="remove-form" action="{{route('delete.song')}}" method="POST">
    ...
    <script type="text/javascript">
        ...
        function approveSong(id) {
            jQuery.ajax({
                ...
                url: "{{ url(getenv('APP_URL') . '/approve-song') }}",
                method: 'post',
                data: {
                    id: id
                },
        ...
        function addSmartLink(el) {
            jQuery.ajax({
                ...
                url: "{{ url(getenv('APP_URL') . '/add-smart-link') }}",
                method: 'post',
                data: {
