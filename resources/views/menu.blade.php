<div class="iq-sidebar">
    <div class="iq-sidebar-logo d-flex justify-content-between">
        <a href="index.html" class="header-logo">
            <img src="{{asset('assets/image/logo.png')}}" class="img-fluid rounded-normal" alt="">
            <div class="logo-title">
                <span class="text-primary text-uppercase">Muzic</span>
            </div>
        </a>
    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li>
                    <a href="{{route('music')}}" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Music</span></a>
                </li>
                <li>
                    <a href="{{route('musicRoyality')}}" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Royality</span></a>
                </li>
                <li>
                    <a href="analytics.html" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Analytics</span></a>
                </li>
